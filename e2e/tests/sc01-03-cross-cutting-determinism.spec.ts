...
//
// 「횡단 분석 결과의 결정적 재현」 전용 spec (AC1.2).
//
// (종전 헤더는 시나리오 2를 인용했으나 오기였다 — 이 파일이 실제로 단정하는 것은
// 문서 생성·근거 경로·재분석 결정성이고, 그것이 시나리오 3이다.)
//
// docs/test/01-analysis-pipeline.md 시나리오 3을 그대로 따라간다:

...
> **진행 현황 (2026-08-02):** 슬라이스 2를 **2a(백엔드 enqueue 계약) / 2b(S02·S03 프론트)** 로 분할했고, **2a가 완료**됐다(PR #8 `dd5e6ee`, reconciler `rct_20260715-0001`, 2026-07-22 머지). 따라서 **AC1.1은 백엔드 완료 · 프론트(2b) 잔여**의 진행 중 상태다. 아직 미구현으로 남은 것은 **AC1.1 프론트(2b) · AC1.2~1.5 · AC2.1~2.6 · AC3.1~3.5 · AC4.4~4.7**. (다음 권장 슬라이스 = 2b)
...
| 2b | AC1.1 (프론트) | S02 · S03 | 홈 저장소·분석 목록, 저장소 연결, 분석 트리거 UI, pre-flight 비용 안내 — 위 2a 백엔드 API를 소비. **다음 권장 슬라이스** |

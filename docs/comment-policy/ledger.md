...
```
행 열의 합 2,801  +  ⑴ 행 열 밖 잔여 0  +  ⑵ 행 열 안 미판정 증분 8  =  전역 live 2,809
```

이 세 값은 **35차 패스의 트리**(PR head, 부모 `origin/main@bf6bd74`)에서 잰 것이다.

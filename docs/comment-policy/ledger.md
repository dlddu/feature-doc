...
> **9차 패스 기준 갱신 (2026-09-19 · `rct_20260919-0005`).** 위 블록들의 수치는 각 패스의 판정
> 시점 값이라 그대로 두고, 현재 기준만 여기 적는다.
>
